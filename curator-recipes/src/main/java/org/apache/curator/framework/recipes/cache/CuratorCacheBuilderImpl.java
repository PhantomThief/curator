...
class CuratorCacheBuilderImpl implements CuratorCacheBuilder
{
    ...
    private Function<Runnable, CompletableFuture<Void>> runSafeProc;
    ...
    @Override
    public CuratorCacheBuilder withListenerRunProc(Function<Runnable, CompletableFuture<Void>> runSafeProc)
    {
        this.runSafeProc = runSafeProc;
        return this;
    }
    ...
    {
        return new CuratorCacheImpl(client, storage, path, options, exceptionHandler, runSafeProc);
    }
}